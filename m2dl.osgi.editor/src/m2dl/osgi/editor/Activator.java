...
public class Activator implements BundleActivator {
	...
	private static ServiceTracker<IJavaHTMLFormatter, IJavaHTMLFormatter> javaServiceTracker;
	private static ServiceTracker<ICssHTMLFormatter, ICssHTMLFormatter> cssServiceTracker;

	public static ServiceTracker<IJavaHTMLFormatter, IJavaHTMLFormatter> getJavaServiceTracker() {
		return javaServiceTracker;
	}

	public static ServiceTracker<ICssHTMLFormatter, ICssHTMLFormatter> getCssServiceTracker() {
		...
		if (!windowIsRunning) {
			...
			Platform.runLater(() -> {
				try {
					...
					final ServiceTrackerCustomizer<IJavaHTMLFormatter, IJavaHTMLFormatter> javaTrackerCustomizer = new ServiceTrackerImpl(
							bundleContext);
					final ServiceTrackerCustomizer<ICssHTMLFormatter, ICssHTMLFormatter> cssTrackerCustomizer = new CssServiceTrackerImpl(
							bundleContext);
					javaServiceTracker = new ServiceTracker<>(bundleContext, IJavaHTMLFormatter.class.getName(),
							javaTrackerCustomizer);
					cssServiceTracker = new ServiceTracker<>(bundleContext, ICssHTMLFormatter.class.getName(),
							cssTrackerCustomizer);
